...
plot(time2, as.numeric(as.character(data1$Global_active_power)), type = "l", ylab = "Global active power (kilowatts)")
dev.off()

#figure3
png("plot3.png", width = 480, height = 480, units = "px")
plot(time2, as.numeric(as.character(data1$Sub_metering_1)), type = "l", ylab = "Energy sub metering")
...
#figure4
par(mfrow = c())
plot(time2, as.numeric(as.character(data1$Global_active_power)), type = "l", ylab = "Global active power" )
dev.off()